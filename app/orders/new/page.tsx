      ...
      >
        ...
        <section className="flex flex-col gap-3">
          ...
          <textarea
            ...
            className="w-full resize-none rounded-2xl bg-card px-5 py-4 text-base font-medium text-foreground shadow-[0_4px_16px_rgb(var(--foreground-rgb)_/_0.05)] outline-none placeholder:font-medium placeholder:text-muted-foreground focus:ring-2 focus:ring-primary/40"
            required
          />
        </section>
          ...
          <div className="flex items-center gap-3">
            <div className="relative flex-1">
              <input
                ...
                className="w-full rounded-2xl bg-card py-4 pl-5 pr-9 text-base font-semibold text-foreground shadow-[0_4px_16px_rgb(var(--foreground-rgb)_/_0.05)] outline-none placeholder:font-medium placeholder:text-muted-foreground focus:ring-2 focus:ring-primary/40"
              />
        ...
        <section className="flex flex-col gap-3">
          ...
          <textarea
            ...
            className="w-full resize-y rounded-2xl bg-card px-5 py-4 text-base font-medium text-foreground shadow-[0_4px_16px_rgb(var(--foreground-rgb)_/_0.05)] outline-none placeholder:font-medium placeholder:text-muted-foreground focus:ring-2 focus:ring-primary/40"
          />
